...
## Простой генератор облака тегов

Пример результата работы программы на произведении Л. Н. Толстого &laquo;Война и мир&raquo;:

<img src="TagCloudGenerator/TagCloudGenerator/Examples/BigCloudExample.png" width="600" height="600" />
